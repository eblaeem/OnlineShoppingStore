...
namespace OnlineShoppingStore.Application.Services.Products.FacadDesignPattern
{
    public class FacadDesignPattern : IFacadDesignPattern
    {
        ...
        private GetCategoryByIdService _getCategoryById;
        ...
        public GetCategoryByIdService GetGetCategoryById
        {
            get { return _getCategoryById ??= new GetCategoryByIdService(_db); }
        }

        public GetCategoriesCountService GetCategoriesCount
        {
        ...
        public GetAllPropertiesService GetAllPropertiesService
        {
            get { return _getAllPropertiesService ?? new GetAllPropertiesService(_db); }
        }
    }
}
